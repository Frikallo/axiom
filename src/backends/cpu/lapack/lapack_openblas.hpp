...
// OpenBLAS LAPACK backend implementation
// Uses LAPACKE interface from OpenBLAS
...
class OpenBlasLapackBackend : public LapackBackend {
  public:
    OpenBlasLapackBackend() = default;
    ~OpenBlasLapackBackend() override = default;

    // Backend info
    const char *name() const override { return "OpenBLAS"; }
    LapackType type() const override { return LapackType::OpenBLAS; }
