...
int AccelerateLapackBackend::sgetrf(int m, int n, float *a, int lda,
    ...
    __CLPK_integer m_ = m, n_ = n, lda_ = lda;
...
int AccelerateLapackBackend::cgetrf(int m, int n, complex64_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, lda_ = lda;
    cgetrf_(&m_, &n_, reinterpret_cast<__CLPK_complex *>(a), &lda_, ipiv,
            &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zgetrf(int m, int n, complex128_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, lda_ = lda;
    zgetrf_(&m_, &n_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_, ipiv,
            &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::sgetri(int n, float *a, int lda, const int *ipiv,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda, lwork_ = lwork;
...
int AccelerateLapackBackend::cgetri(int n, complex64_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda, lwork_ = lwork;
    cgetri_(&n_, reinterpret_cast<__CLPK_complex *>(a), &lda_,
            const_cast<int *>(ipiv), reinterpret_cast<__CLPK_complex *>(work),
            &lwork_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zgetri(int n, complex128_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda, lwork_ = lwork;
    zgetri_(&n_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_,
            const_cast<int *>(ipiv),
            reinterpret_cast<__CLPK_doublecomplex *>(work), &lwork_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::sgesv(int n, int nrhs, float *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, nrhs_ = nrhs, lda_ = lda, ldb_ = ldb;
...
int AccelerateLapackBackend::cgesv(int n, int nrhs, complex64_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, nrhs_ = nrhs, lda_ = lda, ldb_ = ldb;
    cgesv_(&n_, &nrhs_, reinterpret_cast<__CLPK_complex *>(a), &lda_, ipiv,
           reinterpret_cast<__CLPK_complex *>(b), &ldb_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zgesv(int n, int nrhs, complex128_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, nrhs_ = nrhs, lda_ = lda, ldb_ = ldb;
    zgesv_(&n_, &nrhs_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_,
           ipiv, reinterpret_cast<__CLPK_doublecomplex *>(b), &ldb_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::cgesdd(char jobz, int m, int n, complex64_t *a,
    ...
    __CLPK_integer m_ = m, n_ = n, lda_ = lda, ldu_ = ldu, ldvt_ = ldvt,
                   lwork_ = lwork;
    cgesdd_(&jobz, &m_, &n_, reinterpret_cast<__CLPK_complex *>(a), &lda_, s,
            reinterpret_cast<__CLPK_complex *>(u), &ldu_,
            reinterpret_cast<__CLPK_complex *>(vt), &ldvt_,
            reinterpret_cast<__CLPK_complex *>(work), &lwork_, rwork, iwork,
            &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zgesdd(char jobz, int m, int n, complex128_t *a,
    ...
    __CLPK_integer m_ = m, n_ = n, lda_ = lda, ldu_ = ldu, ldvt_ = ldvt,
                   lwork_ = lwork;
    zgesdd_(&jobz, &m_, &n_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_,
            s, reinterpret_cast<__CLPK_doublecomplex *>(u), &ldu_,
            reinterpret_cast<__CLPK_doublecomplex *>(vt), &ldvt_,
            reinterpret_cast<__CLPK_doublecomplex *>(work), &lwork_, rwork,
            iwork, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::sgeqrf(int m, int n, float *a, int lda, float *tau,
                                    float *work, int lwork) {
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, lda_ = lda, lwork_ = lwork;
...
int AccelerateLapackBackend::sorgqr(int m, int n, int k, float *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, k_ = k, lda_ = lda, lwork_ = lwork;
...
int AccelerateLapackBackend::cgeqrf(int m, int n, complex64_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, lda_ = lda, lwork_ = lwork;
    cgeqrf_(&m_, &n_, reinterpret_cast<__CLPK_complex *>(a), &lda_,
            reinterpret_cast<__CLPK_complex *>(tau),
            reinterpret_cast<__CLPK_complex *>(work), &lwork_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::cungqr(int m, int n, int k, complex64_t *a,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, k_ = k, lda_ = lda, lwork_ = lwork;
    cungqr_(&m_, &n_, &k_, reinterpret_cast<__CLPK_complex *>(a), &lda_,
            reinterpret_cast<__CLPK_complex *>(const_cast<complex64_t *>(tau)),
            reinterpret_cast<__CLPK_complex *>(work), &lwork_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zgeqrf(int m, int n, complex128_t *a, int lda,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, lda_ = lda, lwork_ = lwork;
    zgeqrf_(&m_, &n_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_,
            reinterpret_cast<__CLPK_doublecomplex *>(tau),
            reinterpret_cast<__CLPK_doublecomplex *>(work), &lwork_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zungqr(int m, int n, int k, complex128_t *a,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, k_ = k, lda_ = lda, lwork_ = lwork;
    zungqr_(&m_, &n_, &k_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_,
...
int AccelerateLapackBackend::cpotrf(char uplo, int n, complex64_t *a, int lda) {
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda;
    cpotrf_(&uplo, &n_, reinterpret_cast<__CLPK_complex *>(a), &lda_, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zpotrf(char uplo, int n, complex128_t *a,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda;
    zpotrf_(&uplo, &n_, reinterpret_cast<__CLPK_doublecomplex *>(a), &lda_,
            &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::sgeev(char jobvl, char jobvr, int n, float *a,
                                   ...
                                   int lwork) {
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda, ldvl_ = ldvl, ldvr_ = ldvr,
                   lwork_ = lwork;
...
int AccelerateLapackBackend::cgeev(char jobvl, char jobvr, int n,
    ...
    __CLPK_integer n_ = n, lda_ = lda, ldvl_ = ldvl, ldvr_ = ldvr,
                   lwork_ = lwork;
    cgeev_(&jobvl, &jobvr, &n_, reinterpret_cast<__CLPK_complex *>(a), &lda_,
           reinterpret_cast<__CLPK_complex *>(w),
           reinterpret_cast<__CLPK_complex *>(vl), &ldvl_,
           reinterpret_cast<__CLPK_complex *>(vr), &ldvr_,
           reinterpret_cast<__CLPK_complex *>(work), &lwork_, rwork, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zgeev(char jobvl, char jobvr, int n,
    ...
    __CLPK_integer n_ = n, lda_ = lda, ldvl_ = ldvl, ldvr_ = ldvr,
                   lwork_ = lwork;
    zgeev_(&jobvl, &jobvr, &n_, reinterpret_cast<__CLPK_doublecomplex *>(a),
           &lda_, reinterpret_cast<__CLPK_doublecomplex *>(w),
           reinterpret_cast<__CLPK_doublecomplex *>(vl), &ldvl_,
           reinterpret_cast<__CLPK_doublecomplex *>(vr), &ldvr_,
           reinterpret_cast<__CLPK_doublecomplex *>(work), &lwork_, rwork,
           &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::cheev(char jobz, char uplo, int n, complex64_t *a,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda, lwork_ = lwork;
    cheev_(&jobz, &uplo, &n_, reinterpret_cast<__CLPK_complex *>(a), &lda_, w,
           reinterpret_cast<__CLPK_complex *>(work), &lwork_, rwork, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::zheev(char jobz, char uplo, int n, complex128_t *a,
    ...
    __CLPK_integer info = 0;
    __CLPK_integer n_ = n, lda_ = lda, lwork_ = lwork;
    zheev_(&jobz, &uplo, &n_, reinterpret_cast<__CLPK_doublecomplex *>(a),
           &lda_, w, reinterpret_cast<__CLPK_doublecomplex *>(work), &lwork_,
           rwork, &info);
    return static_cast<int>(info);
}
...
int AccelerateLapackBackend::sgelsd(int m, int n, int nrhs, float *a, int lda,
                                    ...
                                    int *iwork) {
    __CLPK_integer info = 0;
    __CLPK_integer m_ = m, n_ = n, nrhs_ = nrhs, lda_ = lda, ldb_ = ldb,
                   lwork_ = lwork;
    __CLPK_integer rank_ = 0;
...
int AccelerateLapackBackend::cgelsd(int m, int n, int nrhs, complex64_t *a,
    ...
    __CLPK_integer m_ = m, n_ = n, nrhs_ = nrhs, lda_ = lda, ldb_ = ldb,
                   lwork_ = lwork;
    __CLPK_integer rank_ = 0;
    cgelsd_(&m_, &n_, &nrhs_, reinterpret_cast<__CLPK_complex *>(a), &lda_,
            reinterpret_cast<__CLPK_complex *>(b), &ldb_, s, &rcond, &rank_,
            reinterpret_cast<__CLPK_complex *>(work), &lwork_, rwork, iwork,
            &info);
    *rank = static_cast<int>(rank_);
    return static_cast<int>(info);
...
int AccelerateLapackBackend::zgelsd(int m, int n, int nrhs, complex128_t *a,
    ...
    __CLPK_integer m_ = m, n_ = n, nrhs_ = nrhs, lda_ = lda, ldb_ = ldb,
                   lwork_ = lwork;
    __CLPK_integer rank_ = 0;
    zgelsd_(&m_, &n_, &nrhs_, reinterpret_cast<__CLPK_doublecomplex *>(a),
            &lda_, reinterpret_cast<__CLPK_doublecomplex *>(b), &ldb_, s,
            &rcond, &rank_, reinterpret_cast<__CLPK_doublecomplex *>(work),
