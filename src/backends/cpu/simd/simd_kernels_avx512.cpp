// AVX-512 kernel instantiations
// Compile with: -mavx512f -mavx512bw -mavx512dq (Skylake-X, Ice Lake+, 2017+)
...
template void BinaryAdd::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            ...
                                                            const float *,
                                                            float *, size_t);
template void BinaryAdd::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             const double *,
                                                             double *, size_t);
template void BinarySub::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            const float *,
                                                            float *, size_t);
template void BinarySub::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             const double *,
                                                             double *, size_t);
template void BinaryMul::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            const float *,
                                                            float *, size_t);
template void BinaryMul::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             const double *,
                                                             double *, size_t);
template void BinaryDiv::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            const float *,
                                                            float *, size_t);
template void BinaryDiv::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             const double *,
                                                             double *, size_t);
template void BinaryMax::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            const float *,
                                                            float *, size_t);
template void BinaryMax::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             const double *,
                                                             double *, size_t);
template void BinaryMin::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            const float *,
                                                            float *, size_t);
template void BinaryMin::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             const double *,
                                                             double *, size_t);
...
template void UnaryNeg::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                           const float *,
                                                           float *, size_t);
template void UnaryNeg::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                            const double *,
                                                            double *, size_t);
template void UnaryAbs::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                           const float *,
                                                           float *, size_t);
template void UnaryAbs::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                            const double *,
                                                            double *, size_t);
template void UnarySqrt::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            float *, size_t);
template void UnarySqrt::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                             const double *,
                                                             double *, size_t);
template void UnaryExp::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                           const float *,
                                                           float *, size_t);
template void UnaryExp::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                            const double *,
                                                            double *, size_t);
template void UnaryLog::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                           const float *,
                                                           float *, size_t);
template void UnaryLog::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                            const double *,
                                                            double *, size_t);
template void UnarySin::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                           const float *,
                                                           float *, size_t);
template void UnarySin::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                            const double *,
                                                            double *, size_t);
template void UnaryCos::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                           const float *,
                                                           float *, size_t);
template void UnaryCos::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                            const double *,
                                                            double *, size_t);
template void UnaryTanh::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                            const float *,
                                                            float *, size_t);
...
template float ReduceSum::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                             const float *,
                                                             size_t);
template double ReduceSum::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                               const double *,
                                                               size_t);
template float ReduceMax::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                             const float *,
                                                             size_t);
template double ReduceMax::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                               const double *,
                                                               size_t);
template float ReduceMin::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                             const float *,
                                                             size_t);
template double ReduceMin::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                               const double *,
                                                               size_t);
template float ReduceProd::operator()<xsimd::avx512bw, float>(xsimd::avx512bw,
                                                              const float *,
                                                              size_t);
template double ReduceProd::operator()<xsimd::avx512bw, double>(xsimd::avx512bw,
                                                                const double *,
                                                                size_t);
...
template void ActivationReLU::operator()<xsimd::avx512bw, double>(
    xsimd::avx512bw, const double *, double *, size_t);
template void ActivationSigmoid::operator()<xsimd::avx512bw, float>(
    xsimd::avx512bw, const float *, float *, size_t);
template void ActivationSigmoid::operator()<xsimd::avx512bw, double>(
    xsimd::avx512bw, const double *, double *, size_t);
