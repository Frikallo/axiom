...
// Apple Accelerate BLAS backend implementation
// Uses cblas_* functions from the Accelerate framework
...
class AccelerateBlasBackend : public BlasBackend {
  public:
    AccelerateBlasBackend() = default;
    ~AccelerateBlasBackend() override = default;
    ...
    BlasType type() const override { return BlasType::Accelerate; }
};
