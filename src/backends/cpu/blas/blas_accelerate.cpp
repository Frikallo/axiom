...
void AccelerateBlasBackend::sgemm(bool transA, bool transB, size_t M, size_t N,
...
void AccelerateBlasBackend::dgemm(bool transA, bool transB, size_t M, size_t N,
...
void AccelerateBlasBackend::sgemv(bool transA, size_t M, size_t N, float alpha,
...
void AccelerateBlasBackend::dgemv(bool transA, size_t M, size_t N, double alpha,
...
float AccelerateBlasBackend::sdot(size_t n, const float *x, size_t incx,
                                  const float *y, size_t incy) {
    return cblas_sdot(static_cast<int>(n), x, static_cast<int>(incx), y,
                      static_cast<int>(incy));
}

double AccelerateBlasBackend::ddot(size_t n, const double *x, size_t incx,
                                   const double *y, size_t incy) {
    return cblas_ddot(static_cast<int>(n), x, static_cast<int>(incx), y,
                      static_cast<int>(incy));
}

void AccelerateBlasBackend::saxpy(size_t n, float alpha, const float *x,
                                  size_t incx, float *y, size_t incy) {
    cblas_saxpy(static_cast<int>(n), alpha, x, static_cast<int>(incx), y,
                static_cast<int>(incy));
}

void AccelerateBlasBackend::daxpy(size_t n, double alpha, const double *x,
                                  size_t incx, double *y, size_t incy) {
    cblas_daxpy(static_cast<int>(n), alpha, x, static_cast<int>(incx), y,
                static_cast<int>(incy));
}

float AccelerateBlasBackend::snrm2(size_t n, const float *x, size_t incx) {
    return cblas_snrm2(static_cast<int>(n), x, static_cast<int>(incx));
}

double AccelerateBlasBackend::dnrm2(size_t n, const double *x, size_t incx) {
    return cblas_dnrm2(static_cast<int>(n), x, static_cast<int>(incx));
}

void AccelerateBlasBackend::sscal(size_t n, float alpha, float *x,
                                  size_t incx) {
    cblas_sscal(static_cast<int>(n), alpha, x, static_cast<int>(incx));
}

void AccelerateBlasBackend::dscal(size_t n, double alpha, double *x,
                                  size_t incx) {
