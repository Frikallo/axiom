...
std::unique_ptr<Storage> make_storage(size_t size_bytes, Device device = Device::CPU);
std::unique_ptr<Storage> make_storage_view(std::shared_ptr<Storage> base, size_t offset, size_t size_bytes);
